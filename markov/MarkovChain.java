...
public class MarkovChain {
    ...
    public static void main(String[] args) {
        ...
        List<Integer> nums = Arrays.asList(2, 2, 23, 955, 1075, 1337, 7, 24, 35, 2, 35, 1024, 2, 28, 7, 34, 2, 1024, 3, 32, 7, 32, 2, 2, 1024, 996, 2, 1, 18, 2, 9, 1, 26, 22, 33, 29, 2);
        String operators[] = {"**", "^", "|", ">>", "^", "<<", "|", ">>", "<<", "<<", "|", "|", "**", "&", "&", "&", "-", "%", "+", "&", "%", "+", "*"};

        List<Integer> numsXiaohao = Arrays.asList(23, 9, 18, 27, 31, 4, 2, 16, 30, 955, 1075, 1337, 14, 2, 26, 23, 33, 0, 1024, 7, 2, 0, 1024);
